...
import NicestThings from '../SomeNiceThings/NicestThings';
      ...
      <>
        <Route exact path='/'>
          <>
            ...
            <Link to="/the-nicest-things">Gerardo's Things</Link><br/>
          </>
        </Route>
        ...
        <Route exact path='/the-nicest-things'>
          <NicestThings things={this.state.gerardosThings} />
        </Route>
      </>
